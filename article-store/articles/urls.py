...
urlpatterns = [
    ...
    path('/<str:article_id>/<str:version>', ArticleItemAPIView.as_view(), name='article-version'),
    path('/<str:article_id>/<str:version>/<str:part>', ArticleItemAPIView.as_view(), name='article-content'),
