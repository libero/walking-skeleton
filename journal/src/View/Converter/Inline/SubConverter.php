...
final class SubConverter implements ViewConverter
{
    private $converter;
    ...
    public function convert($object, array $context = []) : string
    {
        ...
        return <<<EOT
<sub{$attributes}>{$text}</sub>
EOT;
    }

    public function supports($object, array $context = []) : bool
    {
        return $object instanceof Element && 'sub' === $object->getName() && LIBERO === $object->getNamespace();
    }
}
