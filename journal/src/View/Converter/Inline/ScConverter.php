...
final class ScConverter implements ViewConverter
{
    private $converter;
    ...
    public function convert($object, array $context = []) : string
    {
        ...
        return <<<EOT
<span style="font-variant-caps: small-caps; font-feature-settings: \"smcp\""{$attributes}>{$text}</span>
EOT;
    }

    public function supports($object, array $context = []) : bool
    {
        return $object instanceof Element && 'sc' === $object->getName() && LIBERO === $object->getNamespace();
    }
}
